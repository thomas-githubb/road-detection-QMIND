...
export default function SimpleGoogleMap() {
   ...
   */
  function handlePlaceResult(place: google.maps.places.PlaceResult, type: "start" | "end") {
  ...
  return (
    <div className="relative w-full h-screen">
      ...
      <Script
        src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCfnpEs5JjTMNESW5qkbiHmihxFjcnbgaQ&libraries=places"
        onLoad={initMap}
      />
